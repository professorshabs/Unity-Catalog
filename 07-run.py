...
spark.conf.set("spark.sql.shuffle.partitions", sc.defaultParallelism) #default shuffle partitions of 200, rather use Parallelism, which is the number of cores/vm
spark.conf.set("spark.databricks.delta.optimizeWrite.enabled", True) # recommended
